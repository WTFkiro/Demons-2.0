int Demons_AddLoop2()
{
    for (j = 0; j <= 50; j++)
    {
        leds[7] = CRGB(237, 235, 63);
        leds[6] = CRGB(237, 236, 61);
        leds[5] = CRGB(239, 235, 61);
        leds[4] = CRGB(0, 222, 106);
        leds[3] = CRGB(2, 220, 108);
        leds[2] = CRGB(239, 235, 61);
        leds[1] = CRGB(239, 235, 61);
        leds[0] = CRGB(239, 235, 61);
        ...
        leds[7] = CRGB(81, 61, 252);
        leds[6] = CRGB(80, 62, 253);
        leds[5] = CRGB(78, 62, 255);
        leds[4] = CRGB(80, 61, 255);
        leds[3] = CRGB(80, 62, 253);
        leds[2] = CRGB(80, 62, 253);
        leds[1] = CRGB(80, 61, 255);
