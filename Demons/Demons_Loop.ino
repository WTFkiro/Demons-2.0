int Demons_Loop()
{
    for (k = 0; k <= 1; k++)
    {
        leds[7] = CRGB(252, 252, 50);
        leds[6] = CRGB(252, 252, 52);
        leds[5] = CRGB(252, 252, 54);
        leds[4] = CRGB(153, 97, 210);
        leds[3] = CRGB(151, 98, 210);
        leds[2] = CRGB(252, 252, 52);
        leds[1] = CRGB(252, 252, 52);
        leds[0] = CRGB(252, 252, 54);
        ...
        leds[7] = CRGB(1, 14, 181);
        leds[6] = CRGB(0, 16, 181);
        leds[5] = CRGB(0, 15, 181);
        leds[2] = CRGB(0, 15, 183);
        ...
        leds[14] = CRGB(0, 15, 181);
        leds[22] = CRGB(0, 15, 181);
        leds[21] = CRGB(252, 252, 52);
        leds[18] = CRGB(250, 253, 52);
        leds[17] = CRGB(0, 15, 181);
